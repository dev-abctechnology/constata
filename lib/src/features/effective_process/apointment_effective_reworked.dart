...
class _ApointmentEffectiveReworkedState
  ...
  late AppointmentData _appointmentProvider;
  ...
  @override
  void initState() {
    _appointmentProvider = Provider.of<AppointmentData>(context, listen: false);
  ...
  void initializer() async {
    if (widget.editingMode == true) {
      _effectiveApointment = _appointmentProvider.appointmentData;
      effectives = _appointmentProvider.appointmentData.data.effective;
  ...
  void send() async {
    ...
    if (response == 'created') {
      ...
      _appointmentProvider.clearAppointmentData();
    }
    if (response == 'offline') {
                ...
                children: [
                  ...
                  TextButton(
                      onPressed: () async {
                        ...
                        debugPrint(_appointmentProvider.appointmentData.data
                            .effective.first.effectiveName);
  ...
  Widget build(BuildContext context) {
    ...
    try {
      title =
          'Rascunho - ' + _appointmentProvider.appointmentData.data.datetime;
    } catch (e) {
